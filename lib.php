...
class repository_plupload extends repository {
    ...
    public function get_listing($path = '', $page = '') {
        ...
        $ret['object']['src'] = $CFG->wwwroot . '/repository/plupload/chooser.php';

        $ret['dynload'] = false;
        /*$file = new stdClass();
        $file->label = get_string('attachment', 'repository').': ';
        $file->id   = 'file';
        $file->type = 'file';
        $file->name = 'file';

        $ret['login'] = array($file, $selected);
        $ret['login_btn_label'] = get_string('upload', 'repository');*/
